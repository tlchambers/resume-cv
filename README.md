...
| [Prostate Cancer Interview](https://github.com/tlchambers/ten-mins-presentation)   | To demonstrate skills in React development   | A React application built for a final interview, showcasing a smooth scrolling feature, an about page with a React timeline component, and a SWOTs page with an image slider. Aimed to demonstrate my skills in React development.                                                                                                                                                                    | React, Tailwind CSS                   |       n/a      |
