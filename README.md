...
|                                    Repo                                    | Project Goal                                                                                                                                         | Description                                                                                                                                                                                              | Technologies                                 |      Deployment      |
| :------------------------------------------------------------------------: | ---------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------- | :----------------: |
|        [Portfolio](https://github.com/tlchambers/portfolio)        | Showcasing my skills and projects                                                                    | A responsive website developed using React and Tailwind CSS. It serves as my portfolio, providing an appealing interface for browsing my projects and information.  | JavaScript, Tailwind, React, JSX, HTML, |  Coming Soon!   |
...
| [Calligraphy Website](https://github.com/tlchambers/calligraphy-portfolio) | Developing React knowledge by building a react app                                                                                                   | During the pandemic, I discovered my interest in calligraphy and would send friends and family greeting cards I've made for special occasions or just because! This is a website to showcase my designs. | JavaScript, React, JSX, HTML, CSS            | Coming Soon! |
