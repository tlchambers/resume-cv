...
| :------------------------------------------------------------------------: | ---------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------- | :----------------: |
|        [Portfolio](https://github.com/tlchambers/portfolio)        | Showcasing my skills and projects                                                                    | A responsive website developed using React and Tailwind CSS. It serves as my portfolio, providing an appealing interface for browsing my projects and information.  | JavaScript, Tailwind, React, JSX, HTML, CSS |  [View](https://funny-truffle-8848ef.netlify.app/)    |
