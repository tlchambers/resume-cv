...
|        [Bespoke Cake Small Business](https://github.com/tlchambers/handmade-cakes)        | Develop skills and knowledge in creating a website                                                                    | A responsive handmade cake website built with React and Tailwind CSS. Features include an attractive interface for browsing and ordering custom cakes, as well as a contact form linked to Google Sheets for streamlined communication.  | JavaScript, Tailwind, React, JSX, Google ReCAPTCHA, App Script, HTML, CSS |      [View](https://mellow-kangaroo-0c89a5.netlify.app/)          |
