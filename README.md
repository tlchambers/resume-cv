...
|                                                                       |                                                                                                  |                                                                                                       |                                                   |         |
| :-------------------------------------------------------------------: | ------------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------- | ------------------------------------------------- | :-----: |
|             [Enaidle](https://github.com/SyntheticDBX/Enaidle)             | Final Group Engineering Project with aim to build a web app using the knowledge learnt over the 12 weeks of the coding bootcamp | A web application that connects individuals and organisations who are interested in volunteering or donating items to charitable organisations.                                                                            | MongoDB, Express.js, React, Node.js          |      n/a      |
